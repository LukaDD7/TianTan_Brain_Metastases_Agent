...
# -*- coding: utf-8 -*-
"""
TianTan Brain Metastases Agent - Interactive Main Entry (v5.2 Nine-Module with Executive Summary)
...
9. 【v5.2新增】Module 0 执行摘要，位于报告开头，便于医生快速把握要点
"""
...
**【v5.2新增】报告结构要求：**
报告必须包含9个模块，Module 0 为执行摘要，位于报告开头：
- Module 0: 执行摘要 (Executive Summary) - 核心推荐要点快速一览
- Module 1-8: 详见SKILL.md定义
